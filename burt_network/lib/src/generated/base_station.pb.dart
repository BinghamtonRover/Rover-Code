...
class AntennaFirmwareCommand extends $pb.GeneratedMessage {
  ...
  AntennaFirmwareCommand clone() =>
      AntennaFirmwareCommand()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class BaseStationCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Version>(1, _omitFieldNames ? '' : 'version',
        subBuilder: $0.Version.create)
    ..e<AntennaControlMode>(
        2, _omitFieldNames ? '' : 'mode', $pb.PbFieldType.OE,
        defaultOrMaker: AntennaControlMode.ANTENNA_CONTROL_MODE_UNDEFINED,
        valueOf: AntennaControlMode.valueOf,
    ...
    ..a<$core.double>(
        7, _omitFieldNames ? '' : 'angleTolerance', $pb.PbFieldType.OF,
        protoName: 'angleTolerance')
    ..hasRequiredFields = false;
...
class BaseStationData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.GpsCoordinates>(4, _omitFieldNames ? '' : 'baseStationCoordinates',
        ...
        subBuilder: $2.GpsCoordinates.create)
    ..e<$3.BoolState>(
        5, _omitFieldNames ? '' : 'rtkConnected', $pb.PbFieldType.OE,
        protoName: 'rtkConnected',
        defaultOrMaker: $3.BoolState.BOOL_UNDEFINED,
        valueOf: $3.BoolState.valueOf,
