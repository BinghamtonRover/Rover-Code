...
class MotorData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.BoolState>(1, _omitFieldNames ? '' : 'isMoving', $pb.PbFieldType.OE,
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(
        2, _omitFieldNames ? '' : 'isLimitSwitchPressed', $pb.PbFieldType.OE,
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<MotorDirection>(
        3, _omitFieldNames ? '' : 'direction', $pb.PbFieldType.OE,
        defaultOrMaker: MotorDirection.MOTOR_DIRECTION_UNDEFINED,
        valueOf: MotorDirection.valueOf,
    ...
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'currentAngle', $pb.PbFieldType.OF)
    ..a<$core.double>(
        7, _omitFieldNames ? '' : 'targetAngle', $pb.PbFieldType.OF)
...
class MotorCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'moveRadians', $pb.PbFieldType.OF)
