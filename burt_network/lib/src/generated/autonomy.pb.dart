...
class AutonomyData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<AutonomyState>(1, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: AutonomyState.AUTONOMY_STATE_UNDEFINED,
        valueOf: AutonomyState.valueOf,
        enumValues: AutonomyState.values)
    ..aOM<$0.GpsCoordinates>(2, _omitFieldNames ? '' : 'destination',
        subBuilder: $0.GpsCoordinates.create)
    ..pc<$0.GpsCoordinates>(
        3, _omitFieldNames ? '' : 'obstacles', $pb.PbFieldType.PM,
        subBuilder: $0.GpsCoordinates.create)
    ..pc<$0.GpsCoordinates>(
        4, _omitFieldNames ? '' : 'path', $pb.PbFieldType.PM,
        subBuilder: $0.GpsCoordinates.create)
    ..e<AutonomyTask>(5, _omitFieldNames ? '' : 'task', $pb.PbFieldType.OE,
        defaultOrMaker: AutonomyTask.AUTONOMY_TASK_UNDEFINED,
        valueOf: AutonomyTask.valueOf,
...
class AutonomyCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.GpsCoordinates>(1, _omitFieldNames ? '' : 'destination',
        subBuilder: $0.GpsCoordinates.create)
    ..e<AutonomyTask>(2, _omitFieldNames ? '' : 'task', $pb.PbFieldType.OE,
        defaultOrMaker: AutonomyTask.AUTONOMY_TASK_UNDEFINED,
        valueOf: AutonomyTask.valueOf,
        enumValues: AutonomyTask.values)
