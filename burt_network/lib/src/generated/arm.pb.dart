...
class GripperData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Version>(4, _omitFieldNames ? '' : 'version',
        subBuilder: $2.Version.create)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'servoAngle', $pb.PbFieldType.O3,
        protoName: 'servoAngle')
    ..e<$3.BoolState>(
        6, _omitFieldNames ? '' : 'laserState', $pb.PbFieldType.OE,
        protoName: 'laserState',
...
class GripperCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Version>(9, _omitFieldNames ? '' : 'version',
        subBuilder: $2.Version.create)
    ..a<$core.int>(10, _omitFieldNames ? '' : 'servoAngle', $pb.PbFieldType.O3,
        protoName: 'servoAngle')
    ..e<$3.BoolState>(
        11, _omitFieldNames ? '' : 'laserState', $pb.PbFieldType.OE,
        protoName: 'laserState',
        defaultOrMaker: $3.BoolState.BOOL_UNDEFINED,
        valueOf: $3.BoolState.valueOf,
        enumValues: $3.BoolState.values)
