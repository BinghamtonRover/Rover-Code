...
class ArmData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ArmData', createEmptyInstance: create)
    ...
    ..aOM<$1.MotorData>(3, _omitFieldNames ? '' : 'base', subBuilder: $1.MotorData.create)
    ..aOM<$1.MotorData>(4, _omitFieldNames ? '' : 'shoulder', subBuilder: $1.MotorData.create)
    ..aOM<$1.MotorData>(5, _omitFieldNames ? '' : 'elbow', subBuilder: $1.MotorData.create)
  ...
  @$pb.TagNumber(1)
  set currentPosition($0.Coordinates v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set targetPosition($0.Coordinates v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set base($1.MotorData v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set shoulder($1.MotorData v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set elbow($1.MotorData v) { $_setField(5, v); }
  @$pb.TagNumber(5)
...
class ArmCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ArmCommand', createEmptyInstance: create)
    ...
    ..aOM<$1.MotorCommand>(3, _omitFieldNames ? '' : 'swivel', subBuilder: $1.MotorCommand.create)
    ..aOM<$1.MotorCommand>(4, _omitFieldNames ? '' : 'shoulder', subBuilder: $1.MotorCommand.create)
    ..aOM<$1.MotorCommand>(5, _omitFieldNames ? '' : 'elbow', subBuilder: $1.MotorCommand.create)
    ..aOM<$1.MotorCommand>(6, _omitFieldNames ? '' : 'gripperLift', subBuilder: $1.MotorCommand.create)
    ...
    ..aOM<$2.Version>(11, _omitFieldNames ? '' : 'version', subBuilder: $2.Version.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set swivel($1.MotorCommand v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set shoulder($1.MotorCommand v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasShoulder() => $_has(3);
  @$pb.TagNumber(4)
  void clearShoulder() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  set elbow($1.MotorCommand v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasElbow() => $_has(4);
  @$pb.TagNumber(5)
  void clearElbow() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  set gripperLift($1.MotorCommand v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(11)
  set version($2.Version v) { $_setField(11, v); }
  @$pb.TagNumber(11)
...
class GripperData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GripperData', createEmptyInstance: create)
    ..aOM<$1.MotorData>(1, _omitFieldNames ? '' : 'lift', subBuilder: $1.MotorData.create)
    ..aOM<$1.MotorData>(2, _omitFieldNames ? '' : 'rotate', subBuilder: $1.MotorData.create)
    ..aOM<$1.MotorData>(3, _omitFieldNames ? '' : 'pinch', subBuilder: $1.MotorData.create)
    ...
    ..e<$3.BoolState>(6, _omitFieldNames ? '' : 'laserState', $pb.PbFieldType.OE, protoName: 'laserState', defaultOrMaker: $3.BoolState.BOOL_UNDEFINED, valueOf: $3.BoolState.valueOf, enumValues: $3.BoolState.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set lift($1.MotorData v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set rotate($1.MotorData v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set pinch($1.MotorData v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set version($2.Version v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set laserState($3.BoolState v) { $_setField(6, v); }
  @$pb.TagNumber(6)
...
class GripperCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GripperCommand', createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'stop')
    ..aOB(2, _omitFieldNames ? '' : 'calibrate')
    ..aOM<$1.MotorCommand>(3, _omitFieldNames ? '' : 'lift', subBuilder: $1.MotorCommand.create)
    ..aOM<$1.MotorCommand>(4, _omitFieldNames ? '' : 'rotate', subBuilder: $1.MotorCommand.create)
    ..aOM<$1.MotorCommand>(5, _omitFieldNames ? '' : 'pinch', subBuilder: $1.MotorCommand.create)
    ...
    ..e<$3.BoolState>(11, _omitFieldNames ? '' : 'laserState', $pb.PbFieldType.OE, protoName: 'laserState', defaultOrMaker: $3.BoolState.BOOL_UNDEFINED, valueOf: $3.BoolState.valueOf, enumValues: $3.BoolState.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set lift($1.MotorCommand v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set rotate($1.MotorCommand v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set pinch($1.MotorCommand v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(9)
  set version($2.Version v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set laserState($3.BoolState v) { $_setField(11, v); }
  @$pb.TagNumber(11)
