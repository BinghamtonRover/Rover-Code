...
class ScienceCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        1, _omitFieldNames ? '' : 'carouselMotor', $pb.PbFieldType.OF)
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'scoopMotor', $pb.PbFieldType.OF)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'subsurfaceMotor', $pb.PbFieldType.OF)
    ..e<PumpState>(4, _omitFieldNames ? '' : 'pumps', $pb.PbFieldType.OE,
        defaultOrMaker: PumpState.PUMP_STATE_UNDEFINED,
        valueOf: PumpState.valueOf,
        enumValues: PumpState.values)
    ..e<ServoState>(5, _omitFieldNames ? '' : 'funnel', $pb.PbFieldType.OE,
        defaultOrMaker: ServoState.SERVO_STATE_UNDEFINED,
        valueOf: ServoState.valueOf,
        enumValues: ServoState.values)
    ..e<ServoState>(6, _omitFieldNames ? '' : 'scoop', $pb.PbFieldType.OE,
        defaultOrMaker: ServoState.SERVO_STATE_UNDEFINED,
        valueOf: ServoState.valueOf,
        enumValues: ServoState.values)
    ..e<CarouselCommand>(
        7, _omitFieldNames ? '' : 'carousel', $pb.PbFieldType.OE,
        defaultOrMaker: CarouselCommand.CAROUSEL_COMMAND_UNDEFINED,
        valueOf: CarouselCommand.valueOf,
    ...
    ..e<ScienceState>(11, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: ScienceState.SCIENCE_STATE_UNDEFINED,
        valueOf: ScienceState.valueOf,
...
class ScienceData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ScienceState>(2, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: ScienceState.SCIENCE_STATE_UNDEFINED,
        valueOf: ScienceState.valueOf,
        enumValues: ScienceState.values)
