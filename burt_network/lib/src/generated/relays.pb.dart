...
class RelaysCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.BoolState>(
        1, _omitFieldNames ? '' : 'backLeftMotor', $pb.PbFieldType.OE,
        protoName: 'backLeftMotor',
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(
        2, _omitFieldNames ? '' : 'backRightMotor', $pb.PbFieldType.OE,
        protoName: 'backRightMotor',
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(
        3, _omitFieldNames ? '' : 'frontLeftMotor', $pb.PbFieldType.OE,
        protoName: 'frontLeftMotor',
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(
        4, _omitFieldNames ? '' : 'frontRightMotor', $pb.PbFieldType.OE,
        protoName: 'frontRightMotor',
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(5, _omitFieldNames ? '' : 'arm', $pb.PbFieldType.OE,
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(6, _omitFieldNames ? '' : 'science', $pb.PbFieldType.OE,
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(7, _omitFieldNames ? '' : 'drive', $pb.PbFieldType.OE,
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(8, _omitFieldNames ? '' : 'bypass', $pb.PbFieldType.OE,
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
...
class RelaysData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.BoolState>(8, _omitFieldNames ? '' : 'bypass', $pb.PbFieldType.OE,
        ...
        enumValues: $0.BoolState.values)
    ..e<$0.BoolState>(
        9, _omitFieldNames ? '' : 'mechanicalOverride', $pb.PbFieldType.OE,
        protoName: 'mechanicalOverride',
        defaultOrMaker: $0.BoolState.BOOL_UNDEFINED,
        valueOf: $0.BoolState.valueOf,
        enumValues: $0.BoolState.values)
    ..hasRequiredFields = false;
