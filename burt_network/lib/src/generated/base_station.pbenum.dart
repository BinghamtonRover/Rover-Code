...
class AntennaControlMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<AntennaControlMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static AntennaControlMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
