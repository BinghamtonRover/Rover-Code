...
class PnpResult extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set cameraToTarget($0.Pose3d v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class DetectedObject extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set objectType(DetectedObjectType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(10)
  set bestPnpResult(PnpResult v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set alternatePnpResult(PnpResult v) { $_setField(11, v); }
  @$pb.TagNumber(11)
