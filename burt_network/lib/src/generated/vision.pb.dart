...
class PnpResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'reprojectionError', $pb.PbFieldType.OD,
...
class DetectedObject extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..e<DetectedObjectType>(
        1, _omitFieldNames ? '' : 'objectType', $pb.PbFieldType.OE,
        protoName: 'objectType',
        defaultOrMaker: DetectedObjectType.DETECTION_TYPE_UNDEFINED,
        valueOf: DetectedObjectType.valueOf,
        enumValues: DetectedObjectType.values)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'arucoTagId', $pb.PbFieldType.O3,
        protoName: 'arucoTagId')
    ..a<$core.double>(4, _omitFieldNames ? '' : 'xPosition', $pb.PbFieldType.OF,
        protoName: 'xPosition')
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'relativeSize', $pb.PbFieldType.OF,
        protoName: 'relativeSize')
    ..a<$core.int>(6, _omitFieldNames ? '' : 'centerX', $pb.PbFieldType.O3,
        protoName: 'centerX')
    ..a<$core.int>(7, _omitFieldNames ? '' : 'centerY', $pb.PbFieldType.O3,
        protoName: 'centerY')
